Feature: Crear proyecto
	...
	nuevo proyecto", entonces el sistema me solicitará el ingreso de la descripción
	del proyecto, las fechas de inicio y fin del proyecto, y las horas totales
	estimadas para completar el proyecto
	...
	exitosamente, entonces el sistema deberá informar "no se ha podido crear el
	proyecto" y deberá permitir crearlo nuevamente
	"""
